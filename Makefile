...
ios: $(FRAMEWORKS_IOS)/$(PROJECTNAME).framework
...
$(BINDING_PROJECT_IOS)/Generated_ApiDefinitions.cs:
	sharpie bind -p Generated_ -n $(BINDING_PROJECT_IOS) -o $(BINDING_PROJECT_IOS) -sdk iphoneos $(PROJECT)

$(FRAMEWORKS_IOS)/$(PROJECTNAME).framework: $(FRAMEWORKS_IOS)/$(PROJECTNAME)-simulator.framework $(FRAMEWORKS_IOS)/$(PROJECTNAME)-iphone.framework $(BINDING_PROJECT_IOS)/Generated_ApiDefinitions.cs
...
mac: $(FRAMEWORKS_MAC)/$(PROJECTNAME).framework

$(FRAMEWORKS_MAC)/$(PROJECTNAME).framework: $(BINDING_PROJECT_MACOS)/Generated_ApiDefinitions.cs
...
$(BINDING_PROJECT_MACOS)/Generated_ApiDefinitions.cs:
	 sharpie bind -p Generated_ -n PureLayout.Net -o $(BINDING_PROJECT_MACOS) -sdk macosx -xcodeproj-target PureLayout_Mac $(PROJECT)
